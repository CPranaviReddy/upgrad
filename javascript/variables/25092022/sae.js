let realstring = ['Today is sunday.','We are into seventh module.','You will learn soon javascript.','We are  in the class of javascript module.'];

function comparing(realstring)
{
